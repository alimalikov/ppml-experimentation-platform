...
# Replace the "With Comparisons" preset button (around lines 6437-6465) with this FIXED version:
            ...
            """
            Advanced Column Ordering and Data Presentation System
            
            Implements sophisticated column ordering algorithms with paired metric-comparison
            logic for optimal academic presentation. Essential for thesis-quality data
            visualization and professional research documentation.
            
            Ordering Methodologies:
            - Paired Metric-Comparison Ordering: Groups related metrics with their percentage differences
            - Categorical Grouping: Organizes columns by functional type for logical presentation
            - Importance-Based Hierarchy: Prioritizes columns by academic relevance
            - Alphabetical Organization: Standard lexicographic ordering for consistency
            """
            ...
            if 'comprehensive_selected_columns' in st.session_state and st.session_state.comprehensive_selected_columns:
                ...
                if selected_columns:
                    """
                    Multi-Modal Column Ordering Algorithm Implementation
                    
                    Provides multiple ordering strategies for academic data presentation,
                    each optimized for different analytical contexts and research requirements.
                    """
                    ...
                    if st.session_state.get('comprehensive_column_order', 'Default') == 'Alphabetical':
                        ...
                        """
                        Sophisticated Paired Metric-Comparison Ordering Algorithm
                        
                        Implements advanced pairing logic that groups performance metrics with their
                        corresponding percentage difference columns for optimal academic presentation.
                        Essential for thesis-quality comparative analysis visualization.
                        
                        Algorithm Components:
                        1. Core Column Prioritization: Essential identification data first
                        2. Metric-Comparison Pairing: Each metric followed by its percentage difference
                        3. Intelligent Name Matching: Robust pattern matching for metric-diff association
                        4. Fallback Handling: Comprehensive coverage for edge cases and variations
                        5. Orphan Column Integration: Ensures all selected columns are included
                        """
            ...
            Implements sophisticated filtering algorithms for academic data analysis,
            enabling researchers to focus on specific experimental conditions and
            performance thresholds relevant to their thesis research objectives.
            
            Filtering Capabilities:
            - Model-based filtering: Focus on specific algorithmic implementations
            - Type-based filtering: Original vs. anonymized dataset comparisons
            - Threshold-based filtering: Performance improvement significance analysis
            """
